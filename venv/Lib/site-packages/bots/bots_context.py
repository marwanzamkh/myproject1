...
def set_context(request):
    ...
    if '/?select' in bots_http_path:
        my_context['bots_mindate'] = datetime.datetime.strptime(
            viewlib.datetimefrom(), viewlib.DT_FORMAT)
        my_context['bots_maxdate'] = datetime.datetime.strptime(
            viewlib.datetimeuntil(), viewlib.DT_FORMAT)
